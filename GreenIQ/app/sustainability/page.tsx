...
const ScoreCircle = ({ score }: { score: number }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className={`relative w-24 h-24 rounded-full border-4 ${getColor()} flex items-center justify-center`}
      >
          ...
          <div className="flex flex-col items-center space-y-4 text-center mb-8">
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl">
                Evaluate the environmental impact and sustainability of polymers
              </p>
            </div>
          </div>
          <div className="grid gap-8 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the polymer name to get a comprehensive sustainability
                  score
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive sustainability analysis and scoring
                </CardDescription>
              </CardHeader>
              <CardContent>
                {result ? (
